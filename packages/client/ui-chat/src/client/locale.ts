...
export const zh = {
  ...
  'details.open': '打开任务详情',
  'details.close': '关闭详情',
  'details.tabs': '任务工作台标签页',
  'details.allTabs': '全部标签页',
  'details.addTab': '添加标签页',
  'details.closeTab': '关闭“{title}”',
  'details.noTabs': '从“+”菜单打开任务视图',
  'details.viewError': '此任务视图无法显示',
  'details.retry': '重试',
  ...
  'settings.group.conversation': '对话',
  ...
  'message.failure.missingCredential': '缺少运行所需的凭据，请前往设置完成配置后重试。',
  'message.failure.generic': '任务未能完成，请检查配置后重试。',
  'message.failure.details': '查看技术详情',
...
export const en = {
  ...
  'details.tool': 'Tool',
  'details.open': 'Open task details',
  'details.close': 'Close details',
  'details.tabs': 'Task workbench tabs',
  'details.allTabs': 'All tabs',
  'details.addTab': 'Add tab',
  'details.closeTab': 'Close “{title}”',
  'details.noTabs': 'Open a task view from the add menu',
  'details.viewError': 'This task view could not be displayed',
  'details.retry': 'Retry',
  ...
  'settings.group.conversation': 'Conversation',
  ...
  'message.failure.missingCredential': 'A required credential is missing. Configure it in Settings, then try again.',
  'message.failure.generic': 'The task could not complete. Check your configuration and try again.',
  'message.failure.details': 'Show technical details',
