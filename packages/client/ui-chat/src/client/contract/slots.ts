...
import type {
  ...
  MessageImageLoader, MessageImagesOwnerProps, RenderMessageImages, TurnErrorNode, TurnLocation,
...
/** Turn identity and lifecycle exposed to a product-owned header. */
