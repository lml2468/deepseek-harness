...
export const zh = {
  ...
  'placeholder.hero': '今天帮你做些什么？ @ 引用文件或对话，/ 调用指令',
  ...
  'hero.headline': '有什么可以帮你的吗？',
  'hero.chooseWorkspace': '选择工作区',
  'session.hierarchy': '会话层级',
  'session.actions': '更多任务操作',
  'session.views': '切换任务视图',
  'todo.title': '任务',
...
export const en = {
  ...
  'hero.headline': 'What can I help you with?',
  'hero.chooseWorkspace': 'Choose workspace',
  'session.hierarchy': 'Session hierarchy',
  'session.actions': 'More task actions',
  'session.views': 'Switch task view',
  'todo.title': 'To-dos',
