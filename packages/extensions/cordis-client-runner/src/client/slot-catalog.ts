...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Product-owned identity row shown once before one Turn\'s Assistant response.',
    doc: 'Product-owned identity row shown once before one Turn\'s Assistant response.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.details.view\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Ordered right-hand Workbench Views; only the selected id renders.',
    doc: 'Ordered right-hand Workbench Views; only the selected id renders.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      'client-ui-chat ToolDetailsView id \'tool\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session-maybe',
    summary: 'Ordered product content between the Hero header and composer.',
    doc: 'Ordered product content between the Hero header and composer.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.content\', () => ctx.slots.register(\n      { name: \'conversation.hero.content\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session-maybe',
    summary: 'Ordered product content below the Hero composer and context controls.',
    doc: 'Ordered product content below the Hero composer and context controls.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  {
    key: 'conversation.hero.header',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Product-owned heading for the resident blank-Session Hero.',
    doc: 'Product-owned heading for the resident blank-Session Hero.',
    registerOptions: [],
    ownerProps: [
      '/** Point-in-time state exposed to presentation-only Hero extensions. */\nexport interface ConversationHeroContext {\n  /** Current Session snapshot, absent before the first Workspace is chosen. */\n  readonly session: SessionSnapshot | undefined\n  /** Current resident input state, absent before a Session input shell exists. */\n  readonly input: InputState | undefined\n}',
    ],
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.header\', () => ctx.slots.register(\n      { name: \'conversation.hero.header\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:154',
  },
  {
    key: 'conversation.hero.layout',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Optional composition owner for the resident Hero nodes.',
    doc: 'Optional composition owner for the resident Hero nodes.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.layout\', () => ctx.slots.register(\n      { name: \'conversation.hero.layout\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-chat DetailsLauncher id \'workbench\'',
  ...
  {
    key: 'conversation.turn.error.actions',
    kind: 'list',
    scope: 'session',
    summary: 'Ordered product actions beside a terminal Turn failure.',
    doc: 'Ordered product actions beside a terminal Turn failure.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  {
    key: 'settings.section.group',
    kind: 'keyed',
    scope: 'root',
    summary: 'Optional group heading rendered immediately before one settings section navigation row.',
    doc: 'Optional group heading rendered immediately before one settings section\nnavigation row. The keyed entry uses that section\'s id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.section.group\', () => ctx.slots.register(\n      { name: \'settings.section.group\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'keyed',
    scope: 'root',
    summary: 'Optional semantic icon for one settings section navigation row.',
    doc: 'Optional semantic icon for one settings section navigation row. The\nkeyed entry uses that section\'s id; the shell supplies a neutral icon\nwhen no contribution exists.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
