...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session-maybe',
    summary: 'Ordered product content between the Hero heading and composer.',
    doc: 'Ordered product content between the Hero heading and composer.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Optional composition owner for the already-constructed Hero nodes.',
    doc: 'Optional composition owner for the already-constructed Hero nodes.',
    registerOptions: [],
    ownerProps: [
