...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session-maybe',
    summary: 'Ordered product content between Hero context controls and the composer.',
    doc: 'Ordered product content between Hero context controls and the composer.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
